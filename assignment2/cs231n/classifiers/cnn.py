...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    self.params['b2'] = np.zeros([1,hidden_dim])[0]
    self.params['W3'] = np.random.randn(hidden_dim,num_classes) * weight_scale
    self.params['b3'] = np.zeros([1,num_classes])[0]
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
  ...
  def loss(self, X, y=None):
    ...
    out, h_cache = affine_relu_forward(out, W2, b2)
    scores, s_cache = affine_forward(out, W3, b3)
    ...
    dx, dW3, db3 = affine_backward(ds, s_cache)
    dx, dW2, db2 = affine_relu_backward(dx, h_cache)
    ...
    grads['W1'],grads['W2'],grads['W3'],grads['b1'],grads['b2'],grads['b3'] = dW1,dW2,dW3,db1,db2,db3
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
